...
public class GenerarPlantillaPage extends Page<GenerarPlantillaPage> {

	public GenerarPlantillaPage(WebDriver driver) {
	...
	public String generarPlantillaFactura() {
	...
	public String generarPlantillaHonorarios() {
		String responseMessage = null;
		try {
			waitForWebElementDisplayed(comboTipo);
			safeClick(comboTipo);
	...
	public String generarPlantillaNotaCargo() {
		String responseMessage = null;
		try {
			waitForWebElementDisplayed(comboTipo);
			safeClick(comboTipo);
	...
	public String generarPlantillaNotaCredito() {
		String responseMessage = null;
		try {
			waitForWebElementDisplayed(comboTipo);
			safeClick(comboTipo);
	...
	public String generarPlantillaCartaPorte() {
		String responseMessage = null;
		try {
			waitForWebElementDisplayed(comboTipo);
			safeClick(comboTipo);
	...
	public String generarPlantillaNomina() {
		String responseMessage = null;
		try {
			waitForWebElementDisplayed(comboTipo);
			safeClick(comboTipo);
			...
			Thread.sleep(1000);
			safeSendKeys(txtImporteExento, "1500");
			Thread.sleep(500);
			safeClick(btnAgregarPercepcion);

			Thread.sleep(1500);
			safeClick(btnGuardarPlantillaNomina);
	...
	public String generarPlantillaReciboArrendamiento() {
		String responseMessage = null;
		try {
			waitForWebElementDisplayed(comboTipo);
			safeClick(comboTipo);
